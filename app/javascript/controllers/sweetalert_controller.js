...
export default class extends Controller {
  ...
  itsamatch() {
    ...
    popup.style.backgroundColor = "#FF4D00";
    popup.style.backgroundImage = "radial-gradient(circle farthest-side at top right, transparent, #0F0042), radial-gradient(ellipse farthest-corner at 0% 100%, transparent, #FF4D00)";
    popup.style.animation = "bg-change 10s infinite";
